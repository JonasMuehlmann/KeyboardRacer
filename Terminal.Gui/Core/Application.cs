...
namespace Terminal.Gui {
	...
	public static class Application {
		...
		class MainLoopSyncContext : SynchronizationContext {
			...
			{
				return new Application.MainLoopSyncContext (Application.MainLoop);
			}
		...
		static void Init (Func<Toplevel> topLevelFactory, ConsoleDriver driver = null, IMainLoopDriver mainLoopDriver = null)
		{
			...
			if (driver != null) {
				...
				SynchronizationContext.SetSynchronizationContext (new Application.MainLoopSyncContext (MainLoop));
			}
		...
		/// </summary>
		public static Action<Application.ResizedEventArgs> Loaded;
		...
		public static Application.RunState Begin (Toplevel toplevel)
		{
			...
			var rs = new Application.RunState (toplevel);
			...
			Loaded?.Invoke (new Application.ResizedEventArgs () { Rows = Driver.Rows, Cols = Driver.Cols });
		...
		static void TerminalResized ()
		{
			...
			Resized?.Invoke (new Application.ResizedEventArgs () { Cols = full.Width, Rows = full.Height });
			Driver.Clip = full;
			foreach (var t in toplevels) {
				t.PositionToplevels ();
